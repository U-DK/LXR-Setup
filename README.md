...
* If you choose to install into `/home/<your username>`(Your home but Apache cannot visit at the very beginning), then you don't have to put `sudo` but an extra step you would do in the end.
